...
class ParsersTest {
  ...
  def termSym (name :String) = new LexicalTermSym(termName(name)) {
    override def equals (other :Any) = other match {
      case os :LexicalTermSym => os.name == this.name
    }
  }
  def typeSym (name :String) = new LexicalTypeSym(typeName(name)) {
    override def equals (other :Any) = other match {
      case os :LexicalTypeSym => os.name == this.name
    }
  }
